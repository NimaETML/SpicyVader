...
namespace SpicyVader_Nima_Zarrabi
{
    internal class MainMenu
    {
        ...
        const byte NUMBERMAINMENU = 6;                                                   // Nombre de bouton dans le menu principal
        ...
        public void MainButtons()
        {
            ...
            MainMenuButton[4] = "Classement";
            MainMenuButton[5] = Program.BACK;
        }
        public void LeaveMainMenu()
        {
            ...
            else if (MainMenuButton[Program.PosY] == "Classement")
            {
                Program.PosY = 0;
                Program.PosX = 0;
                RemoveMainMenu();
                new Classement().WriteClassement();
            }
