...
Date dernière modificaion  : 30.10.2023
...
namespace SpicyVader_Nima_Zarrabi
{
    internal class Program
    {
        ...
        public const string VERSION = "1.5.3";                                              // Version du programme (s'affiche dans le menu principal)
        ...
        public static void Main(string[] args)
        {
            ...
            new ShipMissile(0, 0).ShipMissileSpawn();
